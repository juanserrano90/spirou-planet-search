...
def load_polar_parameters() :
    ...
    #  Define normalization line depth for the LSD analyis        - [pol_spirou]
    #p['IC_POLAR_LSD_NORM_DEPTH'] = 1.0
    p['IC_POLAR_LSD_NORM_DEPTH'] = "MEAN"
    #  Whether or not to normalize Stoke I profile to 1.0        - [pol_spirou]
    p['IC_POLAR_LSD_NORM_LSD_STOKES_I'] = True
    #  Define number of edge points in the LSD Stokes I profile to measure continuum   - [pol_spirou]
    p['IC_POLAR_LSD_NEDGEPOINTS_FOR_STOKES_I_CONTINUUM'] = 30
    # Fit line to continuum
    p['IC_POLAR_LSD_FITLINE_TO_STOKES_I_CONTINUUM'] = True
    # To plot continuum measurement of the LSD Stokes I
    p['IC_POLAR_LSD_PLOT_STOKES_I_CONTINUUM'] = False
    ...
    p['IC_POLAR_LSD_WLRANGES'] = [[960.,2430]]

    #  Define minimum line depth to be used in the LSD analyis        - [pol_spirou]
    p['IC_POLAR_LSD_MIN_LINEDEPTH'] = 0.03
    p['IC_POLAR_LSD_MAX_LINEDEPTH'] = 1.00
    ...
    p['IC_POLAR_CONTINUUM_DETECTION_ALGORITHM'] = 'IRAF'
    ...
    p['IC_STOKESI_CONTINUUM_DETECTION_ALGORITHM'] = 'IRAF'
    ...
    p['IC_POLAR_CONT_POLYNOMIAL_FIT'] = False
    #  Define degree of polynomial to fit continuum polarization      - [pol_spirou]
    #p['IC_POLAR_CONT_DEG_POLYNOMIAL'] = 5
    p['IC_POLAR_CONT_DEG_POLYNOMIAL'] = 20
